  ...
  return (
    <>
      ...
      <section className='aboutusSecTwo container'>
        <h1 className='aboutusSecTwohead text-center m-5' data-aos="fade-right">The Greenstraw</h1>
        <div className='my-5 row'>
          <img src={Restaurant} alt='RestaurantImage' className='col-lg-7' data-aos="flip-left"/>
